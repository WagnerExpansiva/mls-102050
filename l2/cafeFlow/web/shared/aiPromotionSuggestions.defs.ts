...
export const definition = {
  ...
  "i18n": {
    ...
    "aiPromotionSuggestions.intent.query.title": "Resultados das sugestões",
    "aiPromotionSuggestions.field.id": "ID do item",
    ...
    "aiPromotionSuggestions.filter.id": "ID do item",
    ...
    "aiPromotionSuggestions.filter.status": "Status",
