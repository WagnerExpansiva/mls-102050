...
export const definition = {
  ...
  "layoutRef": {
    ...
    "layoutId": "dineInOrderLifecycleLayout"
  },
  "states": [
    {
  ...
  "i18n": {
    ...
    "intention.createOrder.form.title": "Novo pedido",
    "intention.addOrderItem.form.title": "Adicionar item",
    "intention.createKitchenTicket.form.title": "Enviar para cozinha",
    "intention.updateOrderStatus.form.title": "Atualizar status do pedido",
    "intention.updateTableStatus.form.title": "Atualizar status da mesa",
    ...
    "field.cancelledAt.label": "Cancelado em",
    ...
    "field.tableStatus.label": "Situação da mesa",
    "action.createOrder.label": "Criar pedido",
    "action.addOrderItem.label": "Adicionar item",
    "action.createKitchenTicket.label": "Criar ticket de cozinha",
    "action.updateOrderStatus.label": "Atualizar status do pedido",
    "action.updateTableStatus.label": "Atualizar ocupação da mesa"
  },
  "automation": {
