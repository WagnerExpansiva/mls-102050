...
export const definition = {
  ...
  "navigationRefs": [],
  "i18n": {
    "openDailyShift.section.openDailyShift.title": "Abrir turno diário",
    ...
    "openDailyShift.intention.createDailyShiftForm.title": "Dados do turno diário",
    "openDailyShift.intention.recordOpeningCashMovementForm.title": "Saldo inicial do caixa",
    "openDailyShift.field.shiftDate.label": "Data do turno",
    "openDailyShift.field.status.label": "Status do turno",
    "openDailyShift.field.openedAt.label": "Abertura do turno",
    "openDailyShift.field.openingCashBalance.label": "Saldo inicial",
    "openDailyShift.field.movementType.label": "Tipo de movimento",
    "openDailyShift.field.amount.label": "Valor",
    "openDailyShift.field.reason.label": "Motivo",
    "openDailyShift.action.createDailyShift.label": "Abrir turno",
    "openDailyShift.action.recordOpeningCashMovement.label": "Registrar abertura"
  },
  "automation": {
