/// <mls fileReference="_102050_/l2/cafeFlow/plugins/impressora.defs.ts" enhancement="_blank"/>

export const impressoraPluginConnectionPlan = {
...
export default impressoraPluginConnectionPlan;
